...
namespace WorkingWidthBD
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\C#\Projct1\WorkingWidthBD\WorkingWidthBD\Database1.mdf;Integrated Security=True";
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (!string.IsNullOrEmpty(textBox4.Text) && !string.IsNullOrWhiteSpace(textBox4.Text))
            {
                ...
                label8.Text = "ID должны быть заполнены!";
            }
            else
            {
                label8.Visible = true;

                label8.Text = "Поля 'Имя' и Цена' должны быть заполнены!";
            }
        }
